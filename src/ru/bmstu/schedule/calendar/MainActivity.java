...
public class MainActivity extends ActionBarActivity {
	...
	try {
	    java.util.Map<String, java.util.List<String>> un = UniversityStructureReader.getFaculties(getAssets().open("university.xml"));
	    String json = ModelsInitializer.fileToString(getAssets().open("rasp.json"), "UTF-8");
	    ExpandableListAdapter adapter = new UniversityExpandableListAdapter(this, un, json);
