...
public class FacultyExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public FacultyExpandableListAdapter(Context context, String json, List<String> cathedraNames) throws IOException {
	this.context = context;

	for (String name: cathedraNames) {
	    Cathedra cathedra = new Cathedra(name);
	    cathedra.setGroupsList(ModelsInitializer.getGroupsForCathedra(json, name));
